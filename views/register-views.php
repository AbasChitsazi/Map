    ...
    <div class="login-box">
        ...
        <?php if (isset($_SESSION['msg'])): ?>
            <?php if ($_SESSION['msg']['status']): ?>
                <p style="margin-right: 40px;color:green"><?= $_SESSION['msg']['message'] ?></p>
            <?php else: ?>
                <p style="margin-right: 40px;color:red"><?= $_SESSION['msg']['message'] ?></p>
            <?php endif; ?>
            <?php unset($_SESSION['msg']);  ?>
        <?php endif; ?>
        <p><a style="color:black;text-decoration: none;margin-right:80px;" href="<?=BASE_URL?>/login.php">حساب کاربری دارید ؟ ورود</a></p>
    </div>
